...
В математике и компьютерной алгебре автоматическое дифференцирование (автодифференцирование, автодифференциал или AD) представляет собой набор методов для вычисления частных производных функции, заданной компьютерной программой.
