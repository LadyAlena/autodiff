...
**Алгоритмическое дифференцирование (автоматическое дифференцирование, AD)** - метод точного вычисления частных производных с помощью применения цепного правила к вычислительному графу функции. Существуют два метода АД: прямой и обратный.
