...
alpha1 = degtorad([-20 -15 -10 -5 0 5 10 15 20 25 30 35 40 45 50 55 60 70 80 90]);
alpha2 = degtorad([-20 -15 -10 -5 0 5 10 15 20 25 30 35 40 45]);
beta1 = degtorad([-30 -25 -20 -15 -10 -8 -6 -4 -2 0 2 4 6 8 10 15 20 25 30]);
fi1 = degtorad([-25 -10 0 10 25]);
fi2 = degtorad([-25 -10 0 10 15 20 25]);
...
for i = 1 : ntraj
    ...
    mzwz(i) = fnval(interpmzwz1, alpha(i)) + fnval(interpmzwz2, alpha(i)).*(dnos / degtorad(25));
...
mz = mz.*eta_fi + dmz_nos.*(dnos / degtorad(25)) + dmz + mzwz.*((Wz.*ba)./(2 * V)) + dmz_sb.*(sb / degtorad(60)) + dmz_ds;
